...
def vcurs(message):
    if message.text == 'Мой Курс❤️':
        ...
        btn5 = types.KeyboardButton('Занятие 5 «Регуляторные системы (Эндокринная и Нервная)» (31.07.23)')
        btn6 = types.KeyboardButton('Занятие 6 «Анализаторы (Органы чувств)» (29.07.23)')
        markup.row(btn1)
        markup.row(btn2)
        markup.row(btn3)
        markup.row(btn4)
...
def zad(message):
    if message.text == 'Занятие 1 «Введение Анатомию» (22.07.23)':
        ...
        bot.send_message(message.chat.id, 'Смотри, учи, запоминай!', reply_markup=markups)
        bot.register_next_step_handler(message, hlp)
    elif message.text == 'Занятие 5 «Регуляторные системы (Эндокринная и Нервная)» (31.07.23)':
        markup = types.InlineKeyboardMarkup()
        markups = types.ReplyKeyboardMarkup()
        btn1 = types.InlineKeyboardButton('Скрипт', url='https://monkeytype.com')
        btn2 = types.InlineKeyboardButton('ДЗ', callback_data='dz1')
        ...
        bot.send_message(message.chat.id, 'Смотри, учи, запоминай!', reply_markup=markups)
        bot.register_next_step_handler(message, hlp)
    elif message.text == 'Занятие 6 «Анализаторы (Органы чувств)» (29.07.23)':
        markup = types.InlineKeyboardMarkup()
        markups = types.ReplyKeyboardMarkup()
        btn1 = types.InlineKeyboardButton('Скрипт', url='https://monkeytype.com')
        btn2 = types.InlineKeyboardButton('ДЗ', callback_data='dz1')
